...
character.greet = function () {
    return `i am "Arya stark" and my title is "Lady of Winterfell"`;
}
...
greet = () =>  alert(`she is "Arya stark" and her title is "Lady of Winterfell"`);
...
character.changeIsAdult = character.isAdult == true ? false : true;
...
character = alert(`Maisie Williams`);
